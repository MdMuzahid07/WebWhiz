                    ...
                    <ul className="flex justify-between max-w-[969px] w-full">
                        ...
                        <li className="w-[185px]">
                            <ul className="w-full">
                                ...
                                <li className="mb-[12px] sm:mb-[8px] lg:mb-[12px] flex items-center gap-[8px]">
                                    <a href="mailto:alexgoat@gmai.com">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M14.1667 17.0832H5.83335C3.33335 17.0832 1.66669 15.8332 1.66669 12.9165V7.08317C1.66669 4.1665 3.33335 2.9165 5.83335 2.9165H14.1667C16.6667 2.9165 18.3334 4.1665 18.3334 7.08317V12.9165C18.3334 15.8332 16.6667 17.0832 14.1667 17.0832Z" stroke="#949498" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M14.1666 7.5L11.5583 9.58333C10.7 10.2667 9.29164 10.2667 8.43331 9.58333L5.83331 7.5" stroke="#949498" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
                                    <p className="text-body text-[16px] sm:text-[14px] lg:text-[16px] leading-[160%]">
                                        alexgoat@gmai.com
                                ...
                                <li className="mb-[12px] sm:mb-[8px] lg:mb-[12px]  flex items-center gap-[8px]">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                        <path d="M10 11.1917C11.436 11.1917 12.6 10.0276 12.6 8.5917C12.6 7.15576 11.436 5.9917 10 5.9917C8.56408 5.9917 7.40002 7.15576 7.40002 8.5917C7.40002 10.0276 8.56408 11.1917 10 11.1917Z" stroke="#949498" stroke-width="1.5" />
                                        <path d="M3.01669 7.07484C4.65836 -0.141827 15.35 -0.133494 16.9834 7.08317C17.9417 11.3165 15.3084 14.8998 13 17.1165C11.325 18.7332 8.67502 18.7332 6.99169 17.1165C4.69169 14.8998 2.05836 11.3082 3.01669 7.07484Z" stroke="#949498" stroke-width="1.5" />
                                    </svg>
                                    <p className="text-body text-[16px] sm:text-[14px] lg:text-[16px] leading-[160%]">
                                ...
                                <li className="mb-[12px] sm:mb-[8px] lg:mb-[12px]  flex items-center gap-[8px]">
                                    <a
                                        ...
                                        rel="noreferrer">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                            <path d="M10 18.3332C14.6024 18.3332 18.3334 14.6022 18.3334 9.99984C18.3334 5.39746 14.6024 1.6665 10 1.6665C5.39765 1.6665 1.66669 5.39746 1.66669 9.99984C1.66669 14.6022 5.39765 18.3332 10 18.3332Z" stroke="#949498" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M6.66667 2.5H7.5C5.875 7.36667 5.875 12.6333 7.5 17.5H6.66667" stroke="#949498" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M12.5 2.5C14.125 7.36667 14.125 12.6333 12.5 17.5" stroke="#949498" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.5 13.3333V12.5C7.36667 14.125 12.6333 14.125 17.5 12.5V13.3333" stroke="#949498" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                            <path d="M2.5 7.5C7.36667 5.875 12.6333 5.875 17.5 7.5" stroke="#949498" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                        </svg>
                                    </a>
