            ...
            <div className="flex justify-center md:justify-between flex-col md:flex-row gap-[20px] w-full h-full lg:h-[526px]">
                ...
                <div className="px-[24px] sm:px-[32px] xl:px-[140px] mb-[52px] sm:mb-[76px] mt-[10px]">
                    ...
                    <div className="mt-[16px] sm:flex sm:items-center sm:gap-[12px]">
                        ...
                        <p className="w-full hidden md:flex sm:w-[323px] lg:hidden text-center sm:text-left text-body text-[16px] font-normal leading-[160%]">
                    ...
                    <div className="relative w-full h-auto px-[11px] sm:px-[32px] xl:px-[140px]">
                        <div className="relative">
                            ...
                            <div className="absolute right-[5px] sm:right-[15px]">
                                ...
                                <div className="absolute -bottom-[30px] -right-[10px] sm:-right-[18px]">
